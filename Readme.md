...
移植は技術的には可能なものの諸々面倒なため、今のところ Windows 上での利用は想定していません。Windows では WSL2 を使ってください。
...
Geforce GTX 1080 (バッチサイズ: 2) で 8000 エポック学習させたときは3時間程度かかりました。

一般的に、2000 ステップ 〜 4000 ステップで十分似た声質になるようです。最大でも 8000 ステップ程度学習させれば十分でしょう。  
8000 ステップも学習させればかなり自然な音声が生成できるようになります。
